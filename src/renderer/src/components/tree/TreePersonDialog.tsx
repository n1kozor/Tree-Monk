          ...
          <div className="flex gap-1 rounded-xl border border-border/40 bg-secondary/40 p-1">
            <button
              ...
              className={cn(
                ...
                mode === 'create' ? 'bg-card text-foreground shadow-[inset_0_1px_0_hsl(var(--glass-highlight)/0.4)] ring-1 ring-primary/20' : 'text-muted-foreground hover:text-foreground'
              )}
            >
            ...
            <button
              ...
              className={cn(
                'flex flex-1 items-center justify-center gap-1.5 rounded-lg px-2 py-1.5 text-xs font-medium transition-colors',
                mode === 'existing' ? 'bg-card text-foreground shadow-[inset_0_1px_0_hsl(var(--glass-highlight)/0.4)] ring-1 ring-primary/20' : 'text-muted-foreground hover:text-foreground'
              )}
            >
                  ...
                  {(['M', 'F', 'U'] as Sex[]).map((s) => (
                    <button
                      ...
                      className={`flex-1 rounded-lg border px-2 py-1.5 text-xs font-medium transition-colors ${
                        sex === s ? 'border-primary/40 bg-primary/15 text-primary ring-1 ring-primary/20' : 'border-border/40 text-muted-foreground hover:bg-accent'
                      }`}
                    >
